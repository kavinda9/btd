<?php
// ============================================================
//  BTD Battles 1 – Past Weekly Player Leaderboard API
//  File: api/past_weekly.php
// ============================================================

require_once __DIR__ . '/../includes/config.php';
require_once __DIR__ . '/cache.php';

function parse_nk_entries_weekly(string $raw): array {
...
$url = NK_BASE_URL . '/storage/static/appdocs/2/leaderboards/WeeklyMedallions:' . $week . '.json';
$cacheFile = CACHE_DIR . 'past_weekly_' . $week . '.json';
...
if ($raw === false) {
    send_error('No weekly leaderboard data found for that week.', 404);
}

$parsed = parse_nk_entries_weekly($raw);
$players = [];
